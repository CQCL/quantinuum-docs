r"""Basic code snippets to use express, operators and states."""
...
# One can list all available test systems:
print(list_h5())
print("")
...
# Hamiltonian operator in canonical orbitals:
...
# Hamiltonian operator in orthogonalized atomic orbitals (Lowdin)
print(h2_3_ring_sto3g.hamiltonian_operator_lowdin.df())
...
hamiltonian = h2_sto3g.hamiltonian_operator.to_FermionOperator()
print(hamiltonian)

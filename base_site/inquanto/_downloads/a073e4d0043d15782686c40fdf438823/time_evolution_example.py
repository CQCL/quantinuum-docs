...
from inquanto.express import run_time_evolution

# For this example, we'll propagate a Hubbard dimer in time and examine how the system evolves.
...
fig.tight_layout()
fig.savefig(f"figure_hubbard_dimer_time_evolution.png")

r"""Computation of the full GF matrix of the Hubbard dimer, and plot the spectral function A(omega)."""
...
# default evaluate uses statevector to produce gf matrix
...
pyplot.savefig("example_gf_measurenorm_matrix_mbgf_spectral.png")
